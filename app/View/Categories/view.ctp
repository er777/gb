<div class="row">
	...
	<div class="col-md-3 col-sm-3 cat">
       ...
       <div id="sidebar-title" class="category">
   
       <h1 class="category-title"><?php echo $category['Category']['name'] ?></h1>
       ...
       <div class="quote-author">-&nbsp;<?php echo $category['Category']['quote_attr'] ?></div>
       <hr />
       
       <div class="gwm-nav"><?php echo $this->Html->link($category['Category']['name'], array('controller' => 'categories', 'action' => 'view', $category['Category']['slug'])); ?></div>
   ...
   <?php if(!empty($auxcategories)) : ?><br />
       <div class="gwm-nav">Related Categories:</div>
   <?php endif; ?>
       <!-- Loop through for auxcategory lookup -->
   
       <?php foreach ($auxcategories as $auxcategory): ?>
           <img src="/img/global/dash-2.png"><?php echo $this->Html->link($auxcategory['Category']['name'], array('controller' => 'categories', 'action' => 'view', $auxcategory['Category']['slug'])); ?><br />
	...
	<div class="col-md-9 col-sm-9 products-block">
		...
		<div class="cat-product-block"><h3 class="gwm-nav">
...
<!--<div id="story_content" style="display:none;color:#000;width:960px;background-color:#fff;padding:20px;">
		...
		<div class="span8 air">
			<h2 class="gwm-heading"><?php echo $category['Category']['name'] ?>
		   <?php echo $this->Html->image('categories/image/' . $category['Category']['image'], array('class' => 'category-pic-small')); ?>
		   </h2>
			<hr />
