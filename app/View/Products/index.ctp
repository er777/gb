...
<div class="row">
	<div class="span3" style="width:270px">
		...
		<div class="gb-nav-container">
			...
			<div class="vendor-logo"> <a href="/"> <?php echo $this->Html->image('users/image/' . $user['User']['image'], array('class' => 'img-polaroid', 'width' =>'226')); ?> </a>
...
<?php */?>
	...
	if(!empty($brands)){?>
		...
		foreach ($brands as $brandslink): ?>
				...
				<span class="gb-nav"><img src="/img/global/dash-2.png"></span> <a href="<?php //echo $fst;?>/brand/<?php echo $brandslink['Brand']['slug'];?>"><?php echo $brandslink['Brand']['name'];?></a>
				<?php } else { ?>
				<?php //echo $this->Html->link($brandslink['Brand']['name'], array('controller' => 'products', 'action' => 'brand',$brandslink['Brand']['slug'])); ?>
				<span class="gb-nav"><img src="/img/global/dash-2.png"></span> <a href="/brand/<?php echo $brandslink['Brand']['slug'];?>"><?php echo $brandslink['Brand']['name'];?></a>
				<?php } }?>
				<br />
		<?php endforeach; 
	}
?>
			...
			<?php 
	if(!empty($ustraditions)){?>
			<a class="gb-nav" href="/ustraditions">US Traditions</a><br/>
			<div style="overflow-y:scroll;height:300px">
				<?php 
			
		foreach ($ustraditions as $ustraditionslink): ?>
				<?php if(!empty($ustraditionslink['Ustradition']['slug'])){?>
				<?php if(!empty($fst)){ ?>
				<?php //echo $this->Html->link($brandslink['Brand']['name'], array('controller' => 'products', 'action' => 'category',$fst,'brand',$brandslink['Brand']['slug'])); ?>
				<span class="gb-nav"><img src="/img/global/dash-2.png"></span> <a href="<?php //echo $fst;?>/brand/<?php echo $ustraditionslink['Ustradition']['slug'];?>"><?php echo $brandslink['Ustradition']['name'];?></a>
				<?php } else { ?>
				<?php //echo $this->Html->link($brandslink['Brand']['name'], array('controller' => 'products', 'action' => 'brand',$brandslink['Brand']['slug'])); ?>
				<span class="gb-nav"><img src="/img/global/dash-2.png"></span> <a href="/brand/<?php echo $ustraditionslink['Ustradition']['slug'];?>"><?php echo $ustraditionslink['Ustradition']['name'];?></a>
				<?php } }?>
				<br />
		<?php endforeach; 
	}
?>
			...
			<div id="story_content" style="display:none;color:#000;width:960px;background-color:#fff;padding:20px;"> <span class="b-close btn-gb"><span>X</span></span>
				<div class="row">
					<div class="span4 left-corner-air"> <?php echo $this->Html->image('users/image/' . $user['User']['image'], array('class' =>'frame vendor-article-logo')); ?> </div>
