...
<div class="row" style="margin-top:20px">
	...
	<div class="col-md-4 earth20"> <span class="bold">Shipping Address</span><br />
		...
		<?php endif; ?>
		<?php echo $shop['Order']['shipping_city'];?>,&nbsp; <?php echo $shop['Order']['shipping_state'];?>&nbsp;&nbsp; <?php echo $shop['Order']['shipping_zip'];?>
	</div>
</div>
...
<?php echo $this->Form->create('Order'); ?> <?php echo $this->Form->hidden('formURL', array('value' => 1)); ?> <?php echo $this->Form->button('<i class="icon-thumbs-up icon-white"></i> Continue', array('class' => 'btn btn-primary pull-right cc', 'ecape' => false)); ?> <?php echo $this->Form->end(); ?>
