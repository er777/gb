...
<?php echo $this->Html->css(array('homepage.css','flexslider.css','mega-menu.css','mega-menu-responsive.css')); ?> 
   ...
   <header>
       <div class="page container">
           ...
           <div class="row">
               ...
               <div class="col-md-4"> 
                   <!-- Logo -->
                   <div class="logo"> <a href="http://www.<?php echo Configure::read('Settings.DOMAIN'); ?>"> 
